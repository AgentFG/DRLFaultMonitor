...
class OS_CNN_easy_use():
    ...
    def __init__(self,Result_log_folder, 
        ...
        Initial_model_path = Result_log_folder +dataset_name+'/'+dataset_name+'_initial_model.pth'
        model_save_path = Result_log_folder +dataset_name+'/'+dataset_name+'_Best_model.pth'
...
def long_data_to_more_channels(a, channels):
    ...
    return np.float32(z)    
# dataset_name = 'BipedalWalkerHCAC'
