...
parser.add_argument('--adasyn', dest='adasyn', action='store_true',
                    help='use adasyn to balance the data')
...
def main_work(args):
    ...
    print('****************************************************')
    if args.smote:
        weights_file = '../../model/{}_smote.pth'.format(args.dataset)
    elif args.adasyn:
        weights_file = '../../model/{}_adasyn.pth'.format(args.dataset)
    else:
        weights_file = '../../model/{}.pth'.format(args.dataset)
